...
class VideoFasterRCNNWithFPNOneStage(TwoStageDetector):
    def __init__(self,
                 backbone,
                 roi_head,
                 train_cfg,
                 ...
                 init_cfg=None,
                 keep_first=False):
        super(VideoFasterRCNNWithFPNOneStage, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=None,
            roi_head=roi_head,
    ...
    #     super(VideoFasterRCNNWithFPNOneStage, self).train(mode)
...
DETECTORS.register_module()(VideoFasterRCNNWithFPNOneStage)
