...
from mmaction.core.evaluation import DistEvalHook
from torch.nn.modules.batchnorm import _BatchNorm

@HOOKS.register_module()
class SubModulesDistEvalHook(DistEvalHook):
    def __init__(self, *args, by_epoch=False, save_best="auto", evaluated_modules=None, **kwargs):
    ...
    def after_train_iter(self, runner):
        # print(f"here(after_train_iter), by_epoch: {self.by_epoch}")
